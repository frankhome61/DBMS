...
public class TestInnerNode {
    ...
    @Test
    public void testPutDuplicate() throws BPlusTreeException {

        DataBox key = new IntDataBox(999);
        RecordId rid = new RecordId(999, (short) 999);
        assertEquals(Optional.empty(), inner.put(key, rid));
        boolean thrown = false;
        try {
            DataBox key2 = new IntDataBox(999);
            RecordId rid2 = new RecordId(999, (short) 999);
            inner.put(key2, rid2);
