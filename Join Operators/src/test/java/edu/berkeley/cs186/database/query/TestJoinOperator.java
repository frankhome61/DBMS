...
public class TestJoinOperator {
  ...
  public void testEmptyJoinPNLJ() throws QueryPlanException, DatabaseException, IOException {
    TestSourceOperator leftSourceOperator = new TestSourceOperator();
    List<Integer> values = new ArrayList<Integer>();
    TestSourceOperator rightSourceOperator = TestUtils.createTestSourceOperatorWithInts(values);
    File tempDir = tempFolder.newFolder("joinTest");
  ...
  @Test (expected = NoSuchElementException.class)
  public void testEmptyJoinBNLJ() throws QueryPlanException, DatabaseException, IOException {
    TestSourceOperator leftSourceOperator = new TestSourceOperator();
    List<Integer> values = new ArrayList<Integer>();
    TestSourceOperator rightSourceOperator = TestUtils.createTestSourceOperatorWithInts(values);
    File tempDir = tempFolder.newFolder("joinTest");
    Database.Transaction transaction = new Database(tempDir.getAbsolutePath()).beginTransaction();
    JoinOperator joinOperator = new BNLJOperator(leftSourceOperator, rightSourceOperator, "int", "int", transaction);
    Iterator<Record> outputIterator = joinOperator.iterator();
    assertFalse(outputIterator.hasNext());
    outputIterator.next();
  }
  ...
  @Test (expected = NoSuchElementException.class)
  public void testLeftRightBothEmptyJoinBNLJ() throws QueryPlanException, DatabaseException, IOException {
    List<Integer> values = new ArrayList<Integer>();
    TestSourceOperator rightSourceOperator = TestUtils.createTestSourceOperatorWithInts(values);
  ...
  @Test (expected = NoSuchElementException.class)
  public void testRightEmptyOnlyJoinBNLJ() throws QueryPlanException, DatabaseException, IOException {
    List<Integer> values = new ArrayList<Integer>();
    TestSourceOperator rightSourceOperator = TestUtils.createTestSourceOperatorWithInts(values);
    TestSourceOperator leftSourceOperator = new TestSourceOperator();
    File tempDir = tempFolder.newFolder("joinTest");
  ...
  @Test (expected = NoSuchElementException.class)
  public void testLeftEmptyOnlyJoinBNLJ() throws QueryPlanException, DatabaseException, IOException {
    List<Integer> values = new ArrayList<Integer>();
    TestSourceOperator leftSourceOperator = TestUtils.createTestSourceOperatorWithInts(values);
    TestSourceOperator rightSourceOperator = new TestSourceOperator();
    File tempDir = tempFolder.newFolder("joinTest");
    Database.Transaction transaction = new Database(tempDir.getAbsolutePath()).beginTransaction();
    assertFalse(leftSourceOperator.iterator().hasNext());
    JoinOperator joinOperator = new BNLJOperator(leftSourceOperator, rightSourceOperator, "int", "int", transaction);
    Iterator<Record> outputIterator = joinOperator.iterator();
    assertFalse(outputIterator.hasNext());
    outputIterator.next();
  ...
  @Test (expected = NoSuchElementException.class)
  public void testLeftRightBothEmptyJoinPNLJ() throws QueryPlanException, DatabaseException, IOException {
    List<Integer> values = new ArrayList<Integer>();
    TestSourceOperator rightSourceOperator = TestUtils.createTestSourceOperatorWithInts(values);
    TestSourceOperator leftSourceOperator = TestUtils.createTestSourceOperatorWithInts(values);
    File tempDir = tempFolder.newFolder("joinTest");
  ...
  @Test (expected = NoSuchElementException.class)
  public void testRightEmptyOnlyJoinPNLJ() throws QueryPlanException, DatabaseException, IOException {
    List<Integer> values = new ArrayList<Integer>();
    TestSourceOperator rightSourceOperator = TestUtils.createTestSourceOperatorWithInts(values);
    TestSourceOperator leftSourceOperator = new TestSourceOperator();
    File tempDir = tempFolder.newFolder("joinTest");
  ...
  @Test (expected = NoSuchElementException.class)
  public void testLeftEmptyOnlyJoinPNLJ() throws QueryPlanException, DatabaseException, IOException {
    List<Integer> values = new ArrayList<Integer>();
    TestSourceOperator leftSourceOperator = TestUtils.createTestSourceOperatorWithInts(values);
    TestSourceOperator rightSourceOperator = new TestSourceOperator();
    File tempDir = tempFolder.newFolder("joinTest");
  ...
  @Test (expected = NoSuchElementException.class)
  public void testBothEmptySortMergeJoin() throws QueryPlanException, DatabaseException, IOException {
  ...
  @Test (expected = NoSuchElementException.class)
  public void testLeftOnlyEmptySortMergeJoin() throws QueryPlanException, DatabaseException, IOException {
    ArrayList<Integer> values = new ArrayList<>();
    TestSourceOperator leftSourceOperator = TestUtils.createTestSourceOperatorWithInts(values);
    TestSourceOperator rightSourceOperator = new TestSourceOperator();
    File tempDir = tempFolder.newFolder("joinTest");
  ...
  @Test (expected = NoSuchElementException.class)
  public void testRightOnlyEmptySortMergeJoin() throws QueryPlanException, DatabaseException, IOException {
    ArrayList<Integer> values = new ArrayList<>();
    TestSourceOperator rightSourceOperator = TestUtils.createTestSourceOperatorWithInts(values);
    TestSourceOperator leftSourceOperator = new TestSourceOperator();
    File tempDir = tempFolder.newFolder("joinTest");
  ...
  @Test
  public void testLeftRightPageWithSameRecordBNLJ() throws QueryPlanException, DatabaseException, IOException{
    File tempDir = tempFolder.newFolder("joinTest");
    Database d = new Database(tempDir.getAbsolutePath(), 4);
    Database.Transaction transaction = d.beginTransaction();
    Record r1 = TestUtils.createRecordWithAllTypesWithValue(1);
    ...
    assertTrue(count == 331776);

  }

  @Test
  public void testLeftRightPageWithSameRecordPNLJ() throws QueryPlanException, DatabaseException, IOException{
    File tempDir = tempFolder.newFolder("joinTest");
    Database d = new Database(tempDir.getAbsolutePath(), 4);
    Database.Transaction transaction = d.beginTransaction();
    Record r1 = TestUtils.createRecordWithAllTypesWithValue(1);
    ...
    QueryOperator s1 = new SequentialScanOperator(transaction,"leftTable");
    QueryOperator s2 = new SequentialScanOperator(transaction,"rightTable");
    QueryOperator joinOperator = new SNLJOperator(s1, s2, "int", "int", transaction);
    Iterator<Record> outputIterator = joinOperator.iterator();
    int count = 0;
    while (outputIterator.hasNext()) {
      Record r = outputIterator.next();
  ...
  @Test
  public void testLeftRightPageWithSameRecordSortMerge() throws QueryPlanException, DatabaseException, IOException{
    File tempDir = tempFolder.newFolder("joinTest");
    Database d = new Database(tempDir.getAbsolutePath(), 4);
    Database.Transaction transaction = d.beginTransaction();
    Record r1 = TestUtils.createRecordWithAllTypesWithValue(1);
  ...
  @Test
  public void testLeftRightPageWithEveryOtherSameRecordSortMerge() throws QueryPlanException, DatabaseException, IOException{
    File tempDir = tempFolder.newFolder("joinTest");
    Database d = new Database(tempDir.getAbsolutePath(), 4);
    Database.Transaction transaction = d.beginTransaction();
    Record r1 = TestUtils.createRecordWithAllTypesWithValue(1);
