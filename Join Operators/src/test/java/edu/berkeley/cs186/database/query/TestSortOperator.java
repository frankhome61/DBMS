...
public class TestSortOperator {
  ...
  public void testEmptySortRun() throws QueryPlanException, DatabaseException, IOException {
    File tempDir = tempFolder.newFolder("sortTest");
    Database d = new Database(tempDir.getAbsolutePath(), 3);
    Database.Transaction transaction = d.beginTransaction();
    d.createTable(TestUtils.createSchemaWithAllTypes(), "table");
  ...
  @Test(expected = NoSuchElementException.class)
  public void testBothEmptyMergeSortedRuns() throws QueryPlanException, DatabaseException, IOException {
    File tempDir = tempFolder.newFolder("sortTest");
    Database d = new Database(tempDir.getAbsolutePath(), 3);
    Database.Transaction transaction = d.beginTransaction();
    d.createTable(TestUtils.createSchemaWithAllTypes(), "table");
  ...
  @Test(timeout=5000)
  public void testOneEmptyOnlyMergeSortedRuns() throws QueryPlanException, DatabaseException, IOException {
    File tempDir = tempFolder.newFolder("sortTest");
    Database d = new Database(tempDir.getAbsolutePath(), 3);
    Database.Transaction transaction = d.beginTransaction();
    d.createTable(TestUtils.createSchemaWithAllTypes(), "table");
