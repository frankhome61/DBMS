...
public class TestLockManager {
    ...
    public void testFIFOOrder() {
        ...
        assertTrue(lockMan.holds(t1, r1, LockManager.LockType.IS));
        assertFalse(lockMan.holds(t2, r1, LockManager.LockType.X));
        assertFalse(lockMan.holds(t3, r1, LockManager.LockType.X));
        assertFalse(lockMan.holds(t1, r1, LockManager.LockType.X));
        ...
        assertFalse(lockMan.holds(t1, r1, LockManager.LockType.IS));
        assertFalse(lockMan.holds(t2, r1, LockManager.LockType.X));
        assertFalse(lockMan.holds(t3, r1, LockManager.LockType.X));
        assertTrue(lockMan.holds(t1, r1, LockManager.LockType.X));
    ...
    public void testQueueOrder() {
        ...
        Transaction t3 = new Transaction("t3", 3);
        Transaction t4 = new Transaction("t4", 4);
        Transaction t5 = new Transaction("t5", 5);
        ...
        lockMan.acquire(t3, r0, LockManager.LockType.X);
        lockMan.acquire(t4, r0, LockManager.LockType.S);
        lockMan.acquire(t5, r0, LockManager.LockType.IX);

        assertTrue(lockMan.holds(t1, r0, LockManager.LockType.X));
        assertFalse(lockMan.holds(t2, r0, LockManager.LockType.IS));
        assertFalse(lockMan.holds(t3, r0, LockManager.LockType.X));
        assertFalse(lockMan.holds(t4, r0, LockManager.LockType.S));
        assertFalse(lockMan.holds(t5, r0, LockManager.LockType.IX));

        lockMan.release(t1, r0);
        assertFalse(lockMan.holds(t1, r0, LockManager.LockType.X));
        assertTrue(lockMan.holds(t2, r0, LockManager.LockType.IS));
        assertFalse(lockMan.holds(t3, r0, LockManager.LockType.X));
        assertTrue(lockMan.holds(t4, r0, LockManager.LockType.S));
        assertFalse(lockMan.holds(t5, r0, LockManager.LockType.IX));
    }
    ...
    public void testNulls() {
        ...
        Table a = new Table("A");
        t1 = null;
        lockMan.acquire(t1, a, LockManager.LockType.S);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testInappropriateParentLock() {
        lockMan = new LockManager();
        Transaction t1 = new Transaction("t1", 1);
        Table a = new Table("A");
        Resource r0 = a;
        ...
        lockMan.acquire(t1, r1, LockManager.LockType.IX);
    }
    ...
    public void testMultipleHolds() {
        ...
        Resource r1 = new Page("1", a);
        Resource r2 = new Page("2", a);
        Resource r3 = new Page("3", a);
        Resource r4 = new Page("4", a);
        Resource r5 = new Page("5", a);

        Transaction t1 = new Transaction("t1", 1);

        lockMan.acquire(t1, r0, LockManager.LockType.IX);
        lockMan.acquire(t1, r1, LockManager.LockType.X);
        lockMan.acquire(t1, r2, LockManager.LockType.X);
        lockMan.acquire(t1, r3, LockManager.LockType.X);
        lockMan.acquire(t1, r4, LockManager.LockType.X);
        lockMan.acquire(t1, r5, LockManager.LockType.X);

        assertTrue(lockMan.holds(t1, r0, LockManager.LockType.IX));
        assertTrue(lockMan.holds(t1, r1, LockManager.LockType.X));
        assertTrue(lockMan.holds(t1, r2, LockManager.LockType.X));
        assertTrue(lockMan.holds(t1, r3, LockManager.LockType.X));
        assertTrue(lockMan.holds(t1, r4, LockManager.LockType.X));
        assertTrue(lockMan.holds(t1, r5, LockManager.LockType.X));
    }
}